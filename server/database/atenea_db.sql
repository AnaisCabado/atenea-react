...
CREATE TABLE IF NOT EXISTS `atenea_db`.`publication` (
  ...
  PRIMARY KEY (`publication_id`, `user_user_id`),
  INDEX `fk_publication_user1_idx` (`user_user_id` ASC) VISIBLE,
...
-- -----------------------------------------------------
-- Table `atenea_db`.`user_has_publication`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `atenea_db`.`user_has_publication` ;

CREATE TABLE IF NOT EXISTS `atenea_db`.`user_has_publication` (
  `user_user_id` INT NOT NULL,
  `publication_publication_id` INT NOT NULL,
  PRIMARY KEY (`user_user_id`, `publication_publication_id`),
  INDEX `fk_user_has_publication_publication1_idx` (`publication_publication_id` ASC) VISIBLE,
  INDEX `fk_user_has_publication_user1_idx` (`user_user_id` ASC) VISIBLE,
